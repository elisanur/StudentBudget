...
public class BudgetPrinter {
    ...
    /**
     * Constructor that creates new BudgetPrinter object. 
     * Initialises budget attribute to specify which budget is used for printing.
     * Creates a new Calc object for calculating relevant calculations.
     *
    ...
    /**
     * Creates a string of the whole budget review. 
     * Review includes income items, expense items and monthly balance. If the 
     * balance amount exceeds budget, review tells the total amount of monthly 
     * excess cash and weekly and daily budget calculated from that. If the total 
     * amount falls short of budget, review states the amount of budget deficit.
     *
